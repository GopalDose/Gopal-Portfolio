...
export default function AwardsPage() {
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <section ref={containerRef} className="relative w-full bg-white py-24 md:py-32 px-8 md:px-16 z-10 min-h-screen">
                            ...
                            <div>
                                ...
                                <div ref={descriptionRef} className="relative z-10 max-w-2xl">
                                    <p className="text-xl md:text-2xl text-gray-700 font-[family-name:var(--font-family-sans)] leading-relaxed">
                                        Recognition of achievements and excellence in competitions, hackathons, and technical challenges.
                                    </p>
                                </div>
                            </div>
                        </div>

                        {/* Scrollable Right Section - Square Cards Grid */}
                        <div ref={awardsRef} className="w-full md:w-1/2">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 md:gap-8">
                                {AWARDS.map((award, index) => (
                                    <div
                                        key={index}
                                        className={`award-card-item group relative ${index % 2 === 1 ? 'mt-12 md:mt-16' : ''}`}
                                    >
                                                ...
                                                <div>
                                                    ...
                                                    {award.teamName && (
                                                        <p className="text-xs md:text-sm text-gray-700 font-medium font-[family-name:var(--font-family-sans)]">
                                                            Team: <span className="text-gray-900">{award.teamName}</span>
                                                        </p>
                                                    )}
                                                </div>
